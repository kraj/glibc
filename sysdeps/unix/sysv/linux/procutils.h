...
/* Open and read the path FILENAME, line per line, and call CLOSURE with
   ...
   The CLOSURE should return true to stop the read, in which case the
   function returns early.

   It returns procutils_read_stop if CLOSURE returned true,
   procutils_read_eof if the file was fully read, or
